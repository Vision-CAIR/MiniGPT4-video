...
echo $exp_name 
python eval_long_videos_tvqa_cleaned.py --add_unknown --index_subtitles_together --neighbours=$NEIGHBOURS  --start=$START --end=$END --batch_size $BATCH_SIZE  --ckpt $CKPT_PATH  --exp_name=$exp_name\
...
# echo $exp_name 
# python eval_long_videos_tvqa_cleaned.py --add_unknown --vision_only --model_summary_only --neighbours=$NEIGHBOURS  --start=$START --end=$END --batch_size $BATCH_SIZE  --name $NAME --ckpt $CKPT_PATH  --exp_name=$exp_name

# # subtiltes only  (eliminate the vision)
# exp_name="subtitles_only"
# echo $exp_name 
# python eval_long_videos_tvqa_cleaned.py --add_unknown --index_subtitles_together --subtitles_only --neighbours=$NEIGHBOURS  --start=$START --end=$END --batch_size $BATCH_SIZE  --name $NAME --ckpt $CKPT_PATH  --exp_name=$exp_name
