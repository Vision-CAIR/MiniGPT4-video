...
if __name__ == "__main__":
    ...
    # for movie in tqdm(llama_vid_eval.movies_dict.keys()):
    #     file_path=os.path.join(llama_vid_eval.save_long_videos_path,movie+".json")
    ...
    #         print("Already processed")
    #     if args.use_chatgpt:
    #         summary = llama_vid_eval.compine_summaries_gpt4(important_data)
    #     else:
    #         summary = llama_vid_eval.compine_summaries(important_data)
