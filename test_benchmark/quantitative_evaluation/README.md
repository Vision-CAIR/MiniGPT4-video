...
| **Evaluation Aspect** | **Video Chat** | **LLaMA Adapter** | **Video LLaMA** | **Video-ChatGPT** |**Minigpt-video**|
| --- |:--------------:|:-----------------:|:--------------:|:-----------------:|:-----------------:|
| Correctness of Information |      2.23      |       2.03        |      1.96      |       2.40   |      **3.08**|   
| Detail Orientation |      2.50      |       2.32        |      2.18      |       2.52        |      **3.014**|
| Contextual Understanding |      2.53      |       2.30        |      2.16      |       2.62        |    **3.57**| 
| Temporal Understanding |      1.94      |       1.98        |      1.82      |       1.98      |   **2.56**      |
| Consistency |      2.24      |       2.15        |      1.79      |       2.37        |      **2.67**    |
...
| Video-LLaVA | 70.7 | 3.9 | 59.2 | 3.5 | **70.00** | **4.00** | 45.3 | 3.3 |
| Minigpt4-video | **72.93** | **3.84** | **59.73** | **3.28** | 67.7 | 3.7 | **46.3** | **3.4** |
